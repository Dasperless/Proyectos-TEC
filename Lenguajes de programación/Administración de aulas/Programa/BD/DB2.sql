...
INSERT INTO `course` VALUES (7,'IC1234','CU1234','curso-1'),(8,'IC1234','CU4565','curso-2');
...
INSERT INTO `periodxcourse` VALUES (10,7,2021,1,'60',21,10),(11,7,2021,1,'61',24,10),(12,8,2021,1,'63',24,15),(13,8,2021,2,'64',25,12);
...
INSERT INTO `reservation` VALUES (12,'2021-08-30','07:30:00','08:30:00',39,10),(13,'2021-08-31','07:30:00','08:30:00',40,10),(14,'2021-08-29','07:30:00','08:30:00',41,10),(15,'2021-08-02','07:30:00','08:30:00',41,11),(16,'2021-08-03','07:30:00','08:30:00',40,13),(17,'2021-08-03','08:30:00','09:30:00',41,12);
...
INSERT INTO `teacher` VALUES (21,117530566,'Dario Vargas'),(24,22222222,'Daniel Villatoro'),(25,79348924,'Sofia Cardozo');
...
BEGIN
    ...
    IF isnull(varClassroomId)
        THEN
            SET outputCode = -1;
    ELSE
        SELECT R.`date`, R.start_time, R.end_time, R.id, P.`year`, P.period, K.courseCode, P.`group`
            FROM reservation R
             inner join periodxcourse P on R.idPeriodXCourse = P.id 
             inner join course K on P.idCourse = K.id
				WHERE varClassroomId = R.idClassroom
					ORDER BY
						R.`date` ASC, 
						R.start_time ASC;
    END IF;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_QueryByDay`(in pDate varchar(100))
BEGIN
    DECLARE varDate DATE;
    SET varDate = (select str_to_date(pDate, '%d/%m/%Y'));
...
-- Dump completed on 2021-08-31  3:20:18
